...
# Input arguments --------------------------------------------------------------
## Examples nohup Rscript GS-GE-beta-2.1.R Simulated-GE-h2a-2-h2ae-2-rhoa-3-rhoae-3 1 > 22-33-1.log 2>&1 &
arg = commandArgs(T)
prefix = arg[1]
rep = as.numeric(arg[2])

# prefix = "Simulated-GE-h2a-2-h2ae-2-rhoa-5-rhoae-5"
# rep = 1
...
# Load data --------------------------------------------------------------------
load(paste0("/public3/zqx/GS-GE/3-GS/",prefix, "_forGS.Rdata"))
